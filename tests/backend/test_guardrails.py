...
from backend.api import evaluate_job_title_with_ai, match_apollo, ApolloMatchRequest, ApolloContact
...
def test_batch_match_apollo_endpoint():
    ...
    contacts = [
        ...
        ApolloContact(
            ...
            company="BetaCorp Automation Unique 987",
            company_domain="betacorpautomation987.com",
            location="Seattle, US",
            employee_count=120,
        ),
        ApolloContact(
